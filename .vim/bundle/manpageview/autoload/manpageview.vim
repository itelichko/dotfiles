...
if !exists("g:manpageview_pgm") && executable("/usr/bin/man")
 let g:manpageview_pgm= "/usr/bin/man"
endif
...
if !exists("g:manpageview_pgm_i") && executable("/usr/bin/info")
" call Decho("installed info help support via manpageview")
 let g:manpageview_pgm_i     = "/usr/bin/info"
